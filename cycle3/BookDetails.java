...
public class BookDetails {
    public static void main(String[] args) {
        ...
        System.out.println("TESMOL SHAJI\n56\n08-04-2024\nQ13:Write a program has class Publisher, Book, Literature and Fiction. Read the information and print the details of books from either the category, using inheritance.");
